                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product-card text-center">
                            ...
                            <div class="product-info">
                                <h5><a href="services.html">Pegasus White - paint</a></h5>
                                <p>24K</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product-card text-center">
                            ...
                            <div class="product-info">
                                <h5><a href="services.html">Fabric Sand - paint</a></h5>
                                <p>24K</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product-card text-center">
                            ...
                            <div class="product-info">
                                <h5><a href="services.html">Chocolate - Deodorizer</a></h5>
                                <p>32K</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product-card text-center">
                            ...
                            <div class="product-info">
                                <h5><a href="services.html">Deodorizer - Blackberry</a></h5>
                                <p>32K</p>
                            </div>
                        </div>
                    </div>
